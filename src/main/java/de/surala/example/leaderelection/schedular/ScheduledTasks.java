package de.surala.example.leaderelection.schedular;

import de.surala.example.leaderelection.ManagerContext;
...
public class ScheduledTasks {
    ...
    public void reportCurrentTime() {
        ...
        if (isLeader()) {
            // Perform the task
            log.info("I am the leader and the time is now {}", dateFormat.format(new Date()));
        } else {
